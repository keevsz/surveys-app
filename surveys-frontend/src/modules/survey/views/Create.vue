<script setup lang="ts">
    ...
    const addQuestion = () => {
        const question = {
            ...
            alternatives: xalternatives.value
        }
    ...
    const editQuestion = ( id : string, index : number ) => {
        ...
        algo.value = store.questions.filter((item : any) => item.idQ === id)
        xi.value = index
    }
        ...
        <div class="border border-gray-100 rounded-md shadow-sm mb-2">
            ...
            <div class="w-full text-center mb-3">
                <button @click="addQuestion"
                    class="border text-lg text-gray-400 hover:cursor-pointer duration-300 ease-in
            ...
            <div v-for="(question, index) in store.questions" :key="question.idQ" class="px-3 py-4">
                <div class="flex items-center mb-3 border-b pb-4">
                    ...
                    <div class="flex w-full h-12">
                        <!-- w-9/12 -->
                        <input type="text"
                            class="w-full pl-2 focus:outline-none"
                            placeholder="Ingresa la pregunta"
                            readonly
                            v-model="question.title">
                        <button class="w-1/4 text-gray-700  duration-200 ease-in-out"
            ...
            <button class="mx-auto border px-3 py-2 rounded-lg bg-green-500/70 text-gray-600
                w-fit block mb-2 font-semibold"
                @click="saveQuestion"
                :disabled="!inputTi">
                Guardar Encuesta
            </button>
            ...
            <Modal :data="algo" :ind="xi" v-if="store.showModal" />
